                    ...
                    <div className="container-fluid">
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-sm-6">
                                    <ol className="breadcrumb float-right">
                                        ...
                                        <li className="breadcrumb-item active"><Link to="/Promo">Promo code </Link></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row d-md-flex justify-content-md-end ">
                            ...
                            <div className="col-sm-6 d-md-flex justify-content-md-end">
                                <Link to="/addPromocode"><button className='btn btn-secondary rounded-pill mb-3'>Add Promo code </button></Link>
                            </div>
                        </div>
                            ...
                            <div className="col-xl-12">
                                <div className="card m-b-30">
                                    <div className="card-body">
                                        <h4 className="mt-0 header-title mb-4">Promo code
