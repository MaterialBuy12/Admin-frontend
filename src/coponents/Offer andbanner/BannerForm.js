            ...
            >
                ...
                {formik => (
                    <Form>
                        ...
                        <Field as="select" className={`form-control shadow-none  ${formik.touched.bannernumber && formik.errors.bannernumber && 'is-invalid'}`} id="title" name="bannernumber">
                                            ...
                                            <ErrorMessage name='bannernumber' component='div' className="error" />
                      
<br/>
                        <label>Banner Image</label>
                        <input type="file" accept="image/*" className={`form-control shadow-none mt-2 ${formik.touched.img && formik.errors.img && 'is-invalid'}`} name='img' placeholder='Image' onChange={(e) =>
