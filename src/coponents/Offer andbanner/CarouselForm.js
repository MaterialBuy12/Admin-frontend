            ...
            >
                ...
                {formik => (
                    <Form>
                        ...
                        <Field as="select" className={`form-control shadow-none  ${formik.touched.carouselnum && formik.errors.carouselnum && 'is-invalid'}`} id="title" name="carouselnum">
                        ...
                        <input type="file" accept="image/*" className={`form-control shadow-none mt-2 ${formik.touched.cauimg && formik.errors.cauimg && 'is-invalid'}`} name='cauimg' placeholder='Image' onChange={(e) =>
